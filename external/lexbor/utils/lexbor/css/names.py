...
length_percentage_normal = "{.type = LXB_CSS_VALUE_NORMAL}"
border_init = "{.style = LXB_CSS_BORDER_NONE, .width = {.type = LXB_CSS_BORDER_MEDIUM}, .color = {.type = LXB_CSS_COLOR_CURRENTCOLOR}}"
border_color_init = "{.type = LXB_CSS_COLOR_CURRENTCOLOR}"
background_init = "{.color = {.type = LXB_CSS_COLOR_TRANSPARENT}}"
...
styles = {
    ...
    "box-shadow": {
        "values": ["none", "inset", "_length"],
        "initial": "&(lxb_css_property_box_shadow_t) {.type = LXB_CSS_BOX_SHADOW_NONE}"
    },
    ...
    "gap": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_gap_t) {.row = %s, .column = %s}" % (length_percentage_normal, length_percentage_normal)},
    "row-gap": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_row_gap_t) " + length_percentage_normal},
    "column-gap": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_column_gap_t) " + length_percentage_normal},
    ...
    "border-color": {"values": [], "initial": "&(lxb_css_property_border_color_t) {.top = %s, .right = %s, .bottom = %s, .left = %s}" % (border_color_init, border_color_init, border_color_init, border_color_init)},
    ...
    "border-radius": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_border_radius_t) {.top_left = {.h = %s, .v = %s}, .top_right = {.h = %s, .v = %s}, .bottom_right = {.h = %s, .v = %s}, .bottom_left = {.h = %s, .v = %s}}" % (length_percentage_0, length_percentage_0, length_percentage_0, length_percentage_0, length_percentage_0, length_percentage_0, length_percentage_0, length_percentage_0)},
    "border-top-left-radius": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_border_top_left_radius_t) {.h = %s, .v = %s}" % (length_percentage_0, length_percentage_0)},
    "border-top-right-radius": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_border_top_right_radius_t) {.h = %s, .v = %s}" % (length_percentage_0, length_percentage_0)},
    "border-bottom-right-radius": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_border_bottom_right_radius_t) {.h = %s, .v = %s}" % (length_percentage_0, length_percentage_0)},
    "border-bottom-left-radius": {"values": ["_length", "_percentage"], "initial": "&(lxb_css_property_border_bottom_left_radius_t) {.h = %s, .v = %s}" % (length_percentage_0, length_percentage_0)},

    "background": {"values": [], "initial": "&(lxb_css_property_background_t) " + background_init},
