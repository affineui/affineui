...
static const lxb_css_entry_data_t lxb_css_property_data[LXB_CSS_PROPERTY__LAST_ENTRY] =
{
    ...
    {(lxb_char_t *) "border-bottom-left-radius", 25, LXB_CSS_PROPERTY_BORDER_BOTTOM_LEFT_RADIUS, lxb_css_property_state_border_bottom_left_radius,
     ...
     &(lxb_css_property_border_bottom_left_radius_t) {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}},
    {(lxb_char_t *) "border-bottom-right-radius", 26, LXB_CSS_PROPERTY_BORDER_BOTTOM_RIGHT_RADIUS, lxb_css_property_state_border_bottom_right_radius,
     ...
     &(lxb_css_property_border_bottom_right_radius_t) {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}},
    {(lxb_char_t *) "border-color", 12, LXB_CSS_PROPERTY_BORDER_COLOR, lxb_css_property_state_border_color,
     ...
     &(lxb_css_property_border_color_t) {.top = {.type = LXB_CSS_COLOR_CURRENTCOLOR}, .right = {.type = LXB_CSS_COLOR_CURRENTCOLOR}, .bottom = {.type = LXB_CSS_COLOR_CURRENTCOLOR}, .left = {.type = LXB_CSS_COLOR_CURRENTCOLOR}}},
    ...
    {(lxb_char_t *) "border-radius", 13, LXB_CSS_PROPERTY_BORDER_RADIUS, lxb_css_property_state_border_radius,
     ...
     &(lxb_css_property_border_radius_t) {.top_left = {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}, .top_right = {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}, .bottom_right = {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}, .bottom_left = {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}}},
    ...
    {(lxb_char_t *) "border-top-left-radius", 22, LXB_CSS_PROPERTY_BORDER_TOP_LEFT_RADIUS, lxb_css_property_state_border_top_left_radius,
     ...
     &(lxb_css_property_border_top_left_radius_t) {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}},
    {(lxb_char_t *) "border-top-right-radius", 23, LXB_CSS_PROPERTY_BORDER_TOP_RIGHT_RADIUS, lxb_css_property_state_border_top_right_radius,
     ...
     &(lxb_css_property_border_top_right_radius_t) {.h = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}, .v = {.type = LXB_CSS_VALUE__LENGTH, .u.length = {.num = 0, .is_float = false}}}},
    ...
    {(lxb_char_t *) "column-gap", 10, LXB_CSS_PROPERTY_COLUMN_GAP, lxb_css_property_state_column_gap,
     ...
     &(lxb_css_property_column_gap_t) {.type = LXB_CSS_VALUE_NORMAL}},
    ...
    {(lxb_char_t *) "gap", 3, LXB_CSS_PROPERTY_GAP, lxb_css_property_state_gap,
     lxb_css_property_gap_create, lxb_css_property_gap_destroy, lxb_css_property_gap_serialize,
     &(lxb_css_property_gap_t) {.row = {.type = LXB_CSS_VALUE_NORMAL}, .column = {.type = LXB_CSS_VALUE_NORMAL}}},
    ...
    {(lxb_char_t *) "row-gap", 7, LXB_CSS_PROPERTY_ROW_GAP, lxb_css_property_state_row_gap,
     ...
     &(lxb_css_property_row_gap_t) {.type = LXB_CSS_VALUE_NORMAL}},
    ...
    {(lxb_char_t *) "border-style", 12, LXB_CSS_PROPERTY_BORDER_STYLE, lxb_css_property_state_border_style,
     ...
     &(lxb_css_property_border_style_t) {.top = LXB_CSS_VALUE_NONE, .right = LXB_CSS_VALUE_NONE, .bottom = LXB_CSS_VALUE_NONE, .left = LXB_CSS_VALUE_NONE}},
    {(lxb_char_t *) "border-width", 12, LXB_CSS_PROPERTY_BORDER_WIDTH, lxb_css_property_state_border_width,
     lxb_css_property_border_width_create, lxb_css_property_border_width_destroy, lxb_css_property_border_width_serialize,
     &(lxb_css_property_border_width_t) {.top = {.type = LXB_CSS_VALUE_MEDIUM}, .right = {.type = LXB_CSS_VALUE_MEDIUM}, .bottom = {.type = LXB_CSS_VALUE_MEDIUM}, .left = {.type = LXB_CSS_VALUE_MEDIUM}}},
    {(lxb_char_t *) "border-top-width", 16, LXB_CSS_PROPERTY_BORDER_TOP_WIDTH, lxb_css_property_state_border_top_width,
     ...
     &(lxb_css_property_border_top_width_t) {.type = LXB_CSS_VALUE_MEDIUM}},
    {(lxb_char_t *) "border-right-width", 18, LXB_CSS_PROPERTY_BORDER_RIGHT_WIDTH, lxb_css_property_state_border_right_width,
     ...
     &(lxb_css_property_border_right_width_t) {.type = LXB_CSS_VALUE_MEDIUM}},
    {(lxb_char_t *) "border-bottom-width", 19, LXB_CSS_PROPERTY_BORDER_BOTTOM_WIDTH, lxb_css_property_state_border_bottom_width,
     ...
     &(lxb_css_property_border_bottom_width_t) {.type = LXB_CSS_VALUE_MEDIUM}},
    {(lxb_char_t *) "border-left-width", 17, LXB_CSS_PROPERTY_BORDER_LEFT_WIDTH, lxb_css_property_state_border_left_width,
     ...
     &(lxb_css_property_border_left_width_t) {.type = LXB_CSS_VALUE_MEDIUM}},
    /* border-collapse: collapse | separate. Initial = separate (not collapsed). */
    {(lxb_char_t *) "border-collapse", 15, LXB_CSS_PROPERTY_BORDER_COLLAPSE, lxb_css_property_state_border_collapse,
     ...
     &(lxb_css_property_border_collapse_t) {LXB_CSS_VALUE__UNDEF}},
    ...
    {(lxb_char_t *) "list-style", 10, LXB_CSS_PROPERTY_LIST_STYLE, lxb_css_property_state_list_style_type,
     lxb_css_property_list_style_type_create, lxb_css_property_list_style_type_destroy, lxb_css_property_list_style_type_serialize,
     &(lxb_css_property_list_style_type_t) {.type = LXB_CSS_LIST_STYLE_TYPE_DISC}},
    {(lxb_char_t *) "background-image", 16, LXB_CSS_PROPERTY_BACKGROUND_IMAGE, lxb_css_property_state_background,
     lxb_css_property_background_create, lxb_css_property_background_destroy, lxb_css_property_background_serialize,
     &(lxb_css_property_background_t) {.color = {.type = LXB_CSS_COLOR_TRANSPARENT}, .gradient = {.kind = LXB_CSS_GRADIENT_NONE}}},
    ...
    {(lxb_char_t *) "transform", 9, LXB_CSS_PROPERTY_TRANSFORM, lxb_css_property_state_transform,
     ...
     &(lxb_css_property_transform_t) {.type = LXB_CSS_TRANSFORM_VALUE_NONE}},
    {(lxb_char_t *) "animation", 9, LXB_CSS_PROPERTY_ANIMATION, lxb_css_property_state_animation,
     ...
     &(lxb_css_property_animation_t) {.duration_s = 0, .delay_s = 0, .iteration_count = 1, .timing = LXB_CSS_ANIMATION_TIMING_EASE, .direction = LXB_CSS_ANIMATION_DIRECTION_NORMAL, .fill_mode = LXB_CSS_ANIMATION_FILL_MODE_NONE, .play_state = LXB_CSS_ANIMATION_PLAY_STATE_RUNNING}},
    ...
    {(lxb_char_t *) "inset", 5, LXB_CSS_PROPERTY_INSET, lxb_css_property_state_inset,
     ...
     &(lxb_css_property_inset_t) {.top = {.type = LXB_CSS_VALUE_AUTO, .u.length = {.num = 0, .is_float = false}},
    ...
    {(lxb_char_t *) "background-size", 15, LXB_CSS_PROPERTY_BACKGROUND_SIZE, lxb_css_property_state_background_size,
     ...
     &(lxb_css_property_background_size_t) {.layers = {
         {.width = {.type = LXB_CSS_VALUE_AUTO}, .height = {.type = LXB_CSS_VALUE_AUTO}},
         {.width = {.type = LXB_CSS_VALUE_AUTO}, .height = {.type = LXB_CSS_VALUE_AUTO}},
         {.width = {.type = LXB_CSS_VALUE_AUTO}, .height = {.type = LXB_CSS_VALUE_AUTO}}},
         .layer_count = 1}},
