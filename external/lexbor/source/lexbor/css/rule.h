...
struct lxb_css_rule_declaration {
    ...
    union {
        ...
        lxb_css_property_gap_t                   *gap;
        lxb_css_property_row_gap_t               *row_gap;
        lxb_css_property_column_gap_t            *column_gap;
        ...
        lxb_css_property_border_color_t          *border_color;
        ...
        lxb_css_property_list_style_type_t       *list_style_type;
        ...
        lxb_css_property_border_bottom_right_radius_t *border_bottom_right_radius;
        lxb_css_property_border_bottom_left_radius_t *border_bottom_left_radius;
        lxb_css_property_background_t            *background;
        lxb_css_property_background_color_t      *background_color;
        lxb_css_property_background_size_t       *background_size;
        lxb_css_property_color_t                 *color;
        lxb_css_property_content_t               *content;
        lxb_css_property_opacity_t               *opacity;
        lxb_css_property_transform_t             *transform;
        lxb_css_property_transform_origin_t      *transform_origin;
        lxb_css_property_animation_t             *animation;
        lxb_css_property_animation_name_t        *animation_name;
        lxb_css_property_animation_duration_t    *animation_duration;
        lxb_css_property_animation_timing_function_t *animation_timing_function;
        lxb_css_property_animation_delay_t       *animation_delay;
        lxb_css_property_animation_iteration_count_t *animation_iteration_count;
        lxb_css_property_animation_direction_t   *animation_direction;
        lxb_css_property_animation_fill_mode_t   *animation_fill_mode;
        lxb_css_property_animation_play_state_t  *animation_play_state;
        lxb_css_property_position_t              *position;
        lxb_css_property_inset_t                 *inset;
