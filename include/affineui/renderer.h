...
struct RenderStats {
    ...
    std::uint32_t root_layer_capacity_w{0};
    std::uint32_t root_layer_capacity_h{0};
    std::uint32_t root_layer_content_w{0};
    std::uint32_t root_layer_content_h{0};
    ...
    bool          root_layer_allocated_this_frame{false};
